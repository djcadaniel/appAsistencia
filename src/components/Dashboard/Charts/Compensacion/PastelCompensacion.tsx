...
export const PastelCompensacion = () => {
  ...
  const datosPieCompensacionPorArea = useMemo(() => {
    ...
    // Sumar compensación por área
    filteredData.forEach((r) => {
      compensacionPorArea[r.area] = (compensacionPorArea[r.area] || 0) + r.compensacion;
    });
  ...
  const totalCompensacion = datosPieCompensacionPorArea.reduce(
    (s, i) => s + i.value, 0
  );
              ...
              <PieChart>
                ...
                <g>
                  ...
                  <text
                    ...
                    dy={10}
                  >
                    {totalCompensacion.toLocaleString()}
                  </text>
                  <text
                    x="50%"
                    y="50%"
                ...
                <PieTooltip
                  formatter={(value) => {
                    ...
                    const perc =
                      totalCompensacion > 0
                        ? ((v / totalCompensacion) * 100).toFixed(1)
                        : "0.0";
                    return `${v} compensación (${perc}%)`;
                  }}
                  contentStyle={{
